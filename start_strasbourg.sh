...
iotlab-node --flash gnrc_border_router.elf -l "strasbourg,m3,${mynodes[0]}" -i "${ID}"
iotlab-node --flash firmware/sensor_strasbourg.elf -l "strasbourg,m3,${mynodes[1]}" -i "${ID}"
