...
int main(void)
{
  ...
  coap_command[i++] = "coap";
  coap_command[i++] = "post";
  coap_command[i++] = "2600:1f16:15a8:30b:2e54:6b9b:742c:31fe";
  coap_command[i++] = "5683";
  coap_command[i++] = "/temp";
  char temp_str[60]; // Allocate memory for the temperature string
